...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on {platformName}.{strongEnd}": "{strongStart}Aviso: La eliminaci\u00f3n de la cuenta es permanente.{strongEnd} Por favor lee la informaci\u00f3n de m\u00e1s arriba con atenci\u00f3n antes de proceder. Esta es una acci\u00f3n irreversible, y {strongStart}no podr\u00e1s volver a usar el mismo correo electr\u00f3nico en {platformName}.{strongEnd}", 
