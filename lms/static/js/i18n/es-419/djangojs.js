...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "As we mentioned before, we will lose your certificates obtained in the courses/specializations; and in that sense access to them. That is why we invite you to {htmlStart}obtain a copy of these certificates to keep the support of having studied with us {htmlEnd}and of the skills obtained.": "Como te mencionamos anteriormente, perderemos tus certificados obtenidos en los cursos/especializaciones; y en ese sentido el acceso a ellos. Es por eso, que te invitamos a {htmlStart}obtener una copia de dichos certificados para guardar el respaldo de haber estudiado con nosotros {htmlEnd}y de las habilidades conseguidas.", 
    ...
    "Create a {link_start}Mozilla Backpack{link_end} account, or log in to your existing account": "Crea una cuenta de {link_start}Mozilla Backpack{link_end}, o inicia sesi\u00f3n usando una cuenta existente", 
    ...
    "Once your account is deleted, you cannot use it to take courses on the {platformName} app, {siteName}, or any other site hosted by {platformName}.": "Una vez su cuenta haya sido eliminada, no la podr\u00e1 usar para tomar cursos en la app de {platformName}, {siteName} o en cualquier otro sitio administrado por {platformName}.", 
    ...
    "Please enter your secondary email address below and we will send you instructions for recovering your account and setting a new password.": "Por favor ingrese su direcci\u00f3n de correo electr\u00f3nico secundaria y le enviaremos las instrucciones para recuperar su cuenta y restablecer su contrase\u00f1a.", 
    ...
    "There was an error in setting your goal, please reload the page and try again.": "Ocurri\u00f3 un error estableciendo su objetivo, por favor cargue la p\u00e1gina nuevamente e intente de nuevo.", 
    ...
    "We\u2019re sorry to see you go!": "\u00a1Lamentamos no seguir compartiendo experiencias!", 
    ...
    "You may access your account when single-sign on is not available.": "Puede acceder a su cuenta cuando el inicio de sesi\u00f3n \u00fanico SSO no est\u00e9 disponible.", 
    ...
    "{download_link_start}Download this image (right-click or option-click, save as){link_end} and then {upload_link_start}upload{link_end} it to your backpack.": "{download_link_start}Descarga esta imagen (haz clic derecho o pulsa opci\u00f3n, guardar como){link_end} y despu\u00e9s {upload_link_start}subirla{link_end} a tu mochila.", 
    "{email}": "{email}", 
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on {platformName}.{strongEnd}": "{strongStart}Warning: La eliminaci\u00f3n de la cuenta es permanente.{strongEnd} Por favor lee la informaci\u00f3n de m\u00e1s arriba con atenci\u00f3n antes de proceder. Esta es una acci\u00f3n irreversible, y {strongStart}no podr\u00e1s volver a usar el mismo correo electr\u00f3nico en {platformName}.{strongEnd}", 
